# MiID Document Face Validation Api

![N|Solid](https://miid.bio/wp-content/uploads/2021/06/MiID_ico-100x100.png)

**MiID Document Face Validation** is an API that provides the functionality to connect your platform or system to MiID Gateway Service 
...
**MiID Document Face Validation**  is a commercial Service, to use it contact [info@bytte.com.co](mailto:info@bytte.com.co) for instructions on how to obtain the required resources and access
...
```
-------
## <a name="ValidateDocFacePersonAsyncGateway"></a>Validate Doc Face Person Async
...
Url - POST
> https://servicesdev.miid.bio/Partner/ValidateDocFacePersonAsyncGateway/
